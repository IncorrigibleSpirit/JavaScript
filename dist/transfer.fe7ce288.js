...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/transfer/transfer.helpers.js":[function(require,module,exports) {
"use strict";
...
exports.insertTransfer = exports.getAccount = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// URL y llamada para obtener cuentas

var urlFetchAccount = "".concat("http://localhost:3000/api", "/account");
var getAccount = function getAccount(id) {
  return _axios.default.get("".concat(urlFetchAccount)).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
...
var urlInsertTransfer = "".concat("http://localhost:3000/api", "/transfer");
var insertTransfer = function insertTransfer(newTransfer) {
  return _axios.default.post("".concat(urlInsertTransfer), newTransfer).then(function (_ref2) {
    var data = _ref2.data;
    return data;
  });
};
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js","@lemoncode/fonk-range-number-validator":"../node_modules/@lemoncode/fonk-range-number-validator/dist/@lemoncode/fonk-range-number-validator.esm.js"}],"pages/transfer/transfer.mappers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.viewModelToApi = void 0;
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
// Preguntamos si el Objeto {} recibido es un objeto (terciario).

var viewModelToApi = function viewModelToApi(transfers) {
  return _typeof(transfers) === 'object' && transfers !== null ? formInfoViewModel(transfers) : "Error: " + transfers + " is not an object";
};

//VIEW MODEL
// Ojo: prestar atención a cómo denominar las key especiales y sus values.
exports.viewModelToApi = viewModelToApi;
var formInfoViewModel = function formInfoViewModel(transfer) {
  return {
...
},{}],"pages/transfer/transfer.js":[function(require,module,exports) {
"use strict";

var _router = require("../../core/router");
var _transfer = require("./transfer.helpers");
var _transfer2 = require("./transfer.api");
var _helpers = require("../../common/helpers");
var _transfer3 = require("./transfer.validations");
var _transfer4 = require("./transfer.mappers");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var isTransferMode = Boolean(params.id);
if (isTransferMode) {
  console.log(params.id);
  (0, _transfer2.getAccount)(params.id).then(function (apiAccount) {
    console.log(apiAccount);
    (0, _transfer.setAccountOptions)(apiAccount, params.id);
  });
}

//3. Establecemos modelo de vista de página

var domesticTransfers = {
  "select-account": " ",
  iban: " ",
  name: " ",
  amount: " ",
...
(0, _helpers.onUpdateField)('select-account', function (event) {
  ...
  domesticTransfers = _objectSpread(_objectSpread({}, domesticTransfers), {}, {
    'select-account': value
  });
  _transfer3.formValidation.validateField('select-account', domesticTransfers["select-account"]).then(function (result) {
...
(0, _helpers.onUpdateField)('iban', function (event) {
  ...
  _transfer3.formValidation.validateField('iban', domesticTransfers.iban).then(function (result) {
...
(0, _helpers.onUpdateField)('name', function (event) {
  ...
  _transfer3.formValidation.validateField('name', domesticTransfers.name).then(function (result) {
...
(0, _helpers.onUpdateField)('amount', function (event) {
  ...
  _transfer3.formValidation.validateField('amount', domesticTransfers.amount).then(function (result) {
...
(0, _helpers.onUpdateField)('concept', function (event) {
  ...
  _transfer3.formValidation.validateField('concept', domesticTransfers.concept).then(function (result) {
...
(0, _helpers.onUpdateField)('day', function (event) {
  ...
  domesticTransfers = _objectSpread(_objectSpread({}, domesticTransfers), {}, {
    day: value,
    date: "".concat(domesticTransfers.year, "-").concat(domesticTransfers.month, "-").concat(value)
  });
  _transfer3.formValidation.validateField('day', domesticTransfers.day).then(function (result) {
...
(0, _helpers.onUpdateField)('month', function (event) {
  ...
  domesticTransfers = _objectSpread(_objectSpread({}, domesticTransfers), {}, {
    month: value,
    date: "".concat(domesticTransfers.year, "-").concat(value, "-").concat(domesticTransfers.day)
  });
  _transfer3.formValidation.validateField('month', domesticTransfers.month).then(function (result) {
    (0, _helpers.onSetError)('date', result);
  });
});
(0, _helpers.onUpdateField)('year', function (event) {
  ...
  domesticTransfers = _objectSpread(_objectSpread({}, domesticTransfers), {}, {
    year: value,
    date: "".concat(value, "-").concat(domesticTransfers.month, "-").concat(domesticTransfers.day)
  });
  _transfer3.formValidation.validateField('year', domesticTransfers.year).then(function (result) {
    (0, _helpers.onSetError)('date', result);
  });
});
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _transfer3.formValidation.validateField('email', domesticTransfers.email).then(function (result) {
...
var onNavigate = function onNavigate(deposit) {
  if (deposit) {
    //history.back();
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  _transfer3.formValidation.validateForm(domesticTransfers).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);
    if (result.succeeded) {
      var infoInVisualMode = (0, _transfer4.viewModelToApi)(domesticTransfers);
      console.log(infoInVisualMode);
      (0, _transfer2.insertTransfer)(infoInVisualMode).then(function (newTransfer) {
        onNavigate(newTransfer);
      });
    }
  });
});
},{"../../core/router":"core/router/index.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","./transfer.api":"pages/transfer/transfer.api.js","../../common/helpers":"common/helpers/index.js","./transfer.validations":"pages/transfer/transfer.validations.js","./transfer.mappers":"pages/transfer/transfer.mappers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
