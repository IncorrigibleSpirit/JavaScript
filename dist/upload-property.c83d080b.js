...
var onAddFile = exports.onAddFile = function onAddFile(id, callback) {
  ...
  input.onchange = function () {
    // Tan pronto se genera un cambio - Selecciona un archivo...
    var file = input.files[0]; // la función obtiene el archivo seleccionado y lo almacena en la variable file
    var fileReader = new FileReader(); // Permite leer el contenido de un archivo
    fileReader.onloadend = function () {
      // Tan pronto el archivo haya sido leído y cargado...haz lo siguiente
...
//Convertir data de la promesa a formato checkbox del elemento HTML - Gestion de Checkbox
var formatCheckboxId = exports.formatCheckboxId = function formatCheckboxId(item) {
...
var setCheckboxList = exports.setCheckboxList = function setCheckboxList(list, id) {
...
var setOptionList = exports.setOptionList = function setOptionList(list, id) {
  var listElement = document.getElementById(id);
...
//Ingresar / remover / Formatear caracteristicass

var formatDeleteFeatureButtonId = exports.formatDeleteFeatureButtonId = function formatDeleteFeatureButtonId(feature) {
  return "delete-".concat(feature, "-button");
};
var onAddFeature = exports.onAddFeature = function onAddFeature(feature) {
...
var onRemoveFeature = exports.onRemoveFeature = function onRemoveFeature(feature) {
  var mainFeaturesElement = document.getElementById('mainFeatures');
  var featureContainer = document.getElementById("delete-".concat(feature));
  mainFeaturesElement.removeChild(featureContainer);
};

// Adherir imagenes al formualrio
var onAddImage = exports.onAddImage = function onAddImage(image) {
...
exports.insertNewProperty = exports.getSaleTypeList = exports.getProvinceList = exports.getEquipmentDetail = void 0;
...
var propertyEquipmentsUrl = "".concat("http://localhost:3000/api", "/equipments");
var getEquipmentDetail = exports.getEquipmentDetail = function getEquipmentDetail() {
  return _axios.default.get(propertyEquipmentsUrl).then(function (_ref3) {
    var data = _ref3.data;
    return data;
  });
};
...
var insertNewPropertyData = "".concat("http://localhost:3000/api", "/properties");
var insertNewProperty = exports.insertNewProperty = function insertNewProperty(newProperty) {
  return _axios.default.post("".concat(insertNewPropertyData), newProperty).then(function (_ref4) {
    var data = _ref4.data;
    return data;
  });
};
...
var get_1 = get;
var createDefaultValidationResult = exports.createDefaultValidationResult = function createDefaultValidationResult() {
  return {
    type: '',
    succeeded: true,
    message: ''
...
var createDefaultRecordValidationResult = exports.createDefaultRecordValidationResult = function createDefaultRecordValidationResult() {
  return {
    succeeded: true,
    recordErrors: {}
  };
};
var createDefaultFormValidationResult = exports.createDefaultFormValidationResult = function createDefaultFormValidationResult() {
  return {
    succeeded: true,
    fieldErrors: {},
    recordErrors: {}
...
var FormValidation = exports.FormValidation = function FormValidation(validationSchema) {
  var _this = this;
...
var createFormValidation = exports.createFormValidation = function createFormValidation(validationSchema) {
...
var parseMessageWithCustomArgs = exports.parseMessageWithCustomArgs = function parseMessageWithCustomArgs(message, customArgs) {
...
var validator$1 = exports.rangeNumber = /*#__PURE__*/Object.freeze({
  __proto__: null,
  setErrorMessage: setErrorMessage,
...
var validationSchema = {
  field: {
    title: [{
      ...
      validator: _fonk.Validators.minLength,
      customArgs: {
        length: 10
      },
    ...
    notes: [{
      ...
      validator: _fonk.Validators.maxLength,
      customArgs: {
        length: 1000
      },
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-range-number-validator":"../node_modules/@lemoncode/fonk-range-number-validator/dist/@lemoncode/fonk-range-number-validator.esm.js","@lemoncode/fonk-is-url-validator":"../node_modules/@lemoncode/fonk-is-url-validator/dist/@lemoncode/fonk-is-url-validator.esm.js","@lemoncode/fonk-array-required-validator":"../node_modules/@lemoncode/fonk-array-required-validator/dist/@lemoncode/fonk-array-required-validator.esm.js"}],"core/router/routes.js":[function(require,module,exports) {
"use strict";
...
var routes = exports.routes = _objectSpread(_objectSpread({}, baseRoutes), {}, {
...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/upload-property/upload-property.js":[function(require,module,exports) {
"use strict";
...
Promise.all([(0, _uploadProperty2.getSaleTypeList)(), (0, _uploadProperty2.getProvinceList)(), (0, _uploadProperty2.getEquipmentDetail)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 3),
    saleTypeList = _ref2[0],
    provinceList = _ref2[1],
    equipmentDataList = _ref2[2];
  ...
  (0, _uploadProperty.setCheckboxList)(equipmentDataList, 'equipments');
...
(0, _element.onUpdateField)('price', function (event) {
  var value = Number(event.target.value); // Covertimos a dato numerico
  newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
    price: value
  });
...
var addElementSaleTypes = function addElementSaleTypes(value) {
  newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
    saleTypeIds: [].concat(_toConsumableArray(newProperty.saleTypeIds), [value])
  });
};
var deleteElementSaleTypes = function deleteElementSaleTypes(value) {
  newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
    saleTypeIds: _toConsumableArray(newProperty.saleTypeIds.filter(function (item) {
      return item !== value;
    }))
  });
};
var setEventsSaleTypes = function setEventsSaleTypes(list) {
  list.forEach(function (element) {
    var id = (0, _uploadProperty.formatCheckboxId)(element);
    (0, _element.onUpdateField)(id, function (event) {
      var value = event.target.value; // Obtenemos (1 ó 2 ó 3 ó 4)
      var checkBoxUpdated = event.target.checked; // () obtenemos TRUE/FALSE
      if (checkBoxUpdated) {
        addElementSaleTypes(value);
      } else {
        deleteElementSaleTypes(value);
      }
      _uploadProperty3.formValidation.validateField('saleTypes', newProperty.saleTypeIds).then(function (result) {
        (0, _element.onSetError)('saleTypes', result);
      });
    });
  });
};
...
(0, _element.onUpdateField)('province', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('province', newProperty.province).then(function (result) {
...
var buttonInsert = document.getElementById('insert-feature-button');
buttonInsert.addEventListener('click', function () {
  var value = document.getElementById('newFeature').value;
  if (value !== '') {
    (0, _uploadProperty.onAddFeature)(value);
    newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
      mainFeatures: newProperty.mainFeatures.concat(value)
    });
  } else {
    alert("Ingresa una característica y presiona el botón Insertar");
  }
  var buttonDelete = document.getElementById("delete-".concat(value, "-button"));
  buttonDelete.addEventListener('click', function () {
    (0, _uploadProperty.onRemoveFeature)(value);
    newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
      mainFeatures: newProperty.mainFeatures.filter(function (item) {
        return item !== value;
      })
    });
    _uploadProperty3.formValidation.validateField('newFeature', newProperty.mainFeatures).then(function (result) {
      (0, _element.onSetError)('newFeature', result);
    });
  });
});
...
var addElementequipments = function addElementequipments(value) {
  newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
    equipmentIds: [].concat(_toConsumableArray(newProperty.equipmentIds), [value])
  });
};
var deleteElementequipments = function deleteElementequipments(value) {
  newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
    equipmentIds: _toConsumableArray(newProperty.equipmentIds.filter(function (item) {
      return item !== value;
    }))
  });
};
var setEventsEquipments = function setEventsEquipments(list) {
  list.forEach(function (element) {
    var id = (0, _uploadProperty.formatCheckboxId)(element);
    (0, _element.onUpdateField)(id, function (event) {
      var value = event.target.value; // Obtenemos (1 ó 2 ó 3 ó 4 ó 5 ó 6)
      var checkBoxUpdated = event.target.checked; // () obtenemos TRUE/FALSE
      if (checkBoxUpdated) {
...
(0, _element.onAddFile)('add-image', function (value) {
  ...
  newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
    images: newProperty.images.concat(value)
  });
});
...
var onNavigate = function onNavigate(form) {
  if (form) {
