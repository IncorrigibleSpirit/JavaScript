...
exports.getSaleTypeList = exports.getProvinceList = void 0;
...
Promise.all([(0, _uploadProperty2.getSaleTypeList)(), (0, _uploadProperty2.getProvinceList)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 2),
...
(0, _element.onUpdateField)('newFeature', function (event) {
  var value = event.target.value;
  newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
    newFeature: value
  });
