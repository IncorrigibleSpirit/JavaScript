...
exports.mapAccountListApiToViewModel = void 0;
var mapAccountListApiToViewModel = function mapAccountListApiToViewModel(accountList) {
  return Array.isArray(accountList) ? accountList.map(function (account) {
    return mapAccountApiToViewModel(account);
  }) : [];
};
exports.mapAccountListApiToViewModel = mapAccountListApiToViewModel;
var mapAccountApiToViewModel = function mapAccountApiToViewModel(account) {
  return {
    id: account.id,
    iban: account.iban,
    name: account.name,
...
(0, _accountList.getAccountList)().then(function (accountList) {
  var vmAccountList = (0, _accountList3.mapAccountListApiToViewModel)(accountList);
