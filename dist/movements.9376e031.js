...
var getAccount = function getAccount(id) {
  return _axios.default.get(urlAccounts, {
    params: {
      id: id
    }
  }).then(function (_ref2) {
...
exports.movementsApiToVm = void 0;
var movementsApiToVm = function movementsApiToVm(movementList) {
...
exports.movementsApiToVm = movementsApiToVm;
...
var isMovementsMode = Boolean(params.id);
...
if (isMovementsMode) {
  ...
  (0, _movements.getMovements)(params.id).then(function (apiAccount) {
    var viewModelMovements = (0, _movements2.movementsApiToVm)(apiAccount);
    console.log({
      viewModelMovements: viewModelMovements
    });
    (0, _movements3.addMovementRows)(viewModelMovements); // Genera tabla dinámicamente según data recuperada

    // Recuperar subtitulos de la interface
    (0, _movements.getAccount)(params.id).then(function (apiAccount) {
      console.log(apiAccount);
      (0, _helpers.onSetValues)(apiAccount);
    });
  });
}
},{"./movements.api":"pages/movements/movements.api.js","./movements.mappers":"pages/movements/movements.mappers.js","./movements.helpers":"pages/movements/movements.helpers.js","../../core/router":"core/router/index.js","../../common/helpers":"common/helpers/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
