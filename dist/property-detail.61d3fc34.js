...
exports.getPropertyDetail = exports.getEquipmentDetail = exports.getContactInfo = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// llamada para recuperar las propiedades
var propertyDetailUrl = "".concat("http://localhost:3000/api", "/properties");
var getPropertyDetail = exports.getPropertyDetail = function getPropertyDetail(id) {
  return _axios.default.get("".concat(propertyDetailUrl, "/").concat(id)).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
...
var getEquipmentDetail = exports.getEquipmentDetail = function getEquipmentDetail() {
  return _axios.default.get(propertyEquipmentsUrl).then(function (_ref2) {
    var data = _ref2.data;
    return data;
  });
};
...
var contactInfoUrl = "".concat("http://localhost:3000/api", "/contact");
var getContactInfo = exports.getContactInfo = function getContactInfo(form) {
  return _axios.default.post(contactInfoUrl, form).then(function (_ref3) {
    var data = _ref3.data;
    return data;
...
var setPropertyValues = exports.setPropertyValues = function setPropertyValues(property) {
...
exports.mapPropertyListApiToVm = exports.mapFilterToQueryParams = exports.getRoomWord = void 0;
var mapPropertyListApiToVm = exports.mapPropertyListApiToVm = function mapPropertyListApiToVm(propertyList) {
...
var getRoomWord = exports.getRoomWord = function getRoomWord(rooms) {
...
var mapFilterToQueryParams = exports.mapFilterToQueryParams = function mapFilterToQueryParams(filter) {
  ...
  if (filter.minRooms) {
    queryParams = "".concat(queryParams, "rooms_gte=").concat(filter.minRooms, "&rooms_lte=").concat(filter.minRooms, "&");
  }
  if (filter.minBathrooms) {
    queryParams = "".concat(queryParams, "bathrooms_gte=").concat(filter.minBathrooms, "&bathrooms_lte=").concat(filter.minBathrooms, "&");
  }
  if (filter.minPrice) {
...
exports.switchToEquipmentNames = exports.propertyViewModel = exports.getBathRoomsWord = void 0;
var _propertyList = require("../property-list/property-list.mappers");
var getBathRoomsWord = exports.getBathRoomsWord = function getBathRoomsWord(bathroom) {
  return bathroom > 1 ? 'baños' : 'baño';
};

// ViewModel (modelado de datos)
var propertyViewModel = exports.propertyViewModel = function propertyViewModel(property, equipmentData) {
  return {
    mainImage: property.images[0],
    title: property.title,
    city: property.city,
    rooms: "".concat(property.rooms, " ").concat((0, _propertyList.getRoomWord)(property.rooms)),
    squareMeter: "".concat(property.squareMeter, " m2"),
    bathrooms: "".concat(property.bathrooms, " ").concat(getBathRoomsWord(property.bathrooms)),
    price: "".concat(property.price.toLocaleString(), "\u20AC"),
    notes: "".concat(property.notes.substring(0, 2000)),
...
//Funcion que permite buscar cuáles indices entre el array y el objeto coinciden.
//Si coinciden, cambiar de Id (número) a "nombre" del equipamiento
var switchToEquipmentNames = exports.switchToEquipmentNames = function switchToEquipmentNames(equipmentArray, equipmentObject) {
  return equipmentArray.map(function (equipmentArrayIdValue) {
    var findEquipment = equipmentObject.find(function (equipmentObjectIdValue) {
      return equipmentObjectIdValue.id === equipmentArrayIdValue;
    });
...
y el id del array. Si se encuentra una coincidencia, se le pedirá a ese objeto resultante
su propiedad ".name."" Y esta es la que se retorna. (.name) se utiliza para acceder 
a la propiedad name de ese objeto específico.
*/
},{"../property-list/property-list.mappers":"pages/property-list/property-list.mappers.js"}],"common/helpers/element.helpers.js":[function(require,module,exports) {
"use strict";
...
var _propertyDetailMappers = require("./property-detail.mappers.js");
var _element = require("../../common/helpers/element.helpers");
var _propertyDetail3 = require("./property-detail.validations");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
Promise.all([(0, _propertyDetail.getPropertyDetail)(params.id), (0, _propertyDetail.getEquipmentDetail)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 2),
    apiAccount = _ref2[0],
    equipmentDataList = _ref2[1];
  ...
  var viewModelProperty = (0, _propertyDetailMappers.propertyViewModel)(apiAccount, equipmentDataList);
  console.log(viewModelProperty);
  //Pintamos informacion en pantalla
  (0, _propertyDetail2.setPropertyValues)(viewModelProperty);
}).catch(function (error) {
...
(0, _element.onUpdateField)('email', function (event) {
  ...
  _propertyDetail3.formValidation.validateField('email', form.email).then(function (result) {
...
(0, _element.onUpdateField)('message', function (event) {
  ...
  _propertyDetail3.formValidation.validateField('message', form.message).then(function (result) {
...
(0, _element.onSubmitForm)('contact-button', function () {
  ...
  _propertyDetail3.formValidation.validateForm(form).then(function (result) {
    (0, _element.onSetFormErrors)(result);
    if (result.succeeded) {
      (0, _propertyDetail.getContactInfo)(form).then(function (contactInfo) {
