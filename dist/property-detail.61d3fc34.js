...
// Llamada para subir a servidor fromulario que diligencia usuario
...
exports.propertyViewModel = void 0;
var _propertyList = require("../property-list/property-list.mappers");
var getBathRoomsWord = function getBathRoomsWord(bathroom) {
...
var propertyViewModel = exports.propertyViewModel = function propertyViewModel(property, equipmentData) {
  return {
    ...
    price: "".concat(property.price.toLocaleString("es-ES"), " \u20AC"),
...
var switchToEquipmentNames = function switchToEquipmentNames(equipmentArray, equipmentObject) {
