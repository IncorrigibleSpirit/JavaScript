...
var iterateAndTransformText = text => {
    ...
    for (var letter of textLowerCase) { //3 Iteramos cada una de las letras de la cadena de texto
        ...
        var LetsTransformLetter = transformLetter(letter,encryptedAlphabet,plainAlphabet);
...
document.getElementById("boxB").innerText = iterateAndTransformText(userTexBoxA())
})
...
event.preventDefault();
document.getElementById("boxA").innerText = iterateAndTransformText(userTextBoxB())
})
