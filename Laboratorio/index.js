var carrito = [
    ...
    var carritoDeCompra = totalCarrito(carrito)
    ...
    var onlyPremium = (array) =>{
    var carritoPremium = carrito.filter(item => item.premium === true)
    return carritoPremium
    }
    
    var productosPremium = onlyPremium(carrito)
    ...
    var valorFinal = descuento(totalCarrito())
